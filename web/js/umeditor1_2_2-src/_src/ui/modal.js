...
UM.ui.define('modal', {
    ...
    show: function () {
        ...
        var classStr = me.root()['0'].getAttribute('class');
        if (classStr.indexOf('image') != -1) {
            console.info('点击图片');
            OpenImageDepot();
        }
        if (classStr.indexOf('video') != -1) {
            console.info('点击视频');
            $('#code').removeClass('error');
            fn['showVideoContainer']();
        }

        /*console.info(this.root()['0'].getAttribute('class').indexOf('image'));
         console.info(this.root()['0'].getAttribute('class').indexOf('video'));*/
