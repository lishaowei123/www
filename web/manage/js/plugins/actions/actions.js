var page_actions = function () {
    ...
    /*$(".gallery-item-remove").on("click",function(){
     var id =$(this).parents(".gallery-item").attr('data-gallery');
     var obj = $(this);
     ajaxPost('/manage/api/images/del',{ids:id}, function(res){
     console.log(res.code);
     if(res.code ==200) {
     obj.parents(".gallery-item").fadeOut(400,function(){
     $(this).remove();
     });
     } else {
     layer.msg('删除失败',1,2);
...
function panel_refresh(panel, action, callback) {
    if (!panel.hasClass("panel-refreshing")) {
        panel.append('<div class="panel-refresh-layer"><img src="/images/manage/default.gif"/></div>');
